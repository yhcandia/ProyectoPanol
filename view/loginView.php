...
textarea.error:not(.basic) { border-color: #2E86C1 !important }
...
body>#pricing h1 a:hover {
    ...
    -moz-box-shadow: 0 0 0 1px #2E86C1;
    -webkit-box-shadow: 0 0 0 1px #2E86C1;
...
#signup_form .switch_signup_method .alt_signup_link:hover { color: #2E86C1 }
...
body>#login form .login_link:hover { color: #2E86C1 }
...
body>#login form#change_password button {
    ...
    margin: 0 auto;
            ...
            body>#login #dont_have_an_account a:hover { border-bottom: 2px solid #2E86C1 }
  </style>
